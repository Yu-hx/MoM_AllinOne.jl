...
"""
在无法连接github情况下,可将github替换为gitee,使用gitee上的仓库。
"""
...
function generate_Pkgs_URLs(; git="github")
...
"""
function clone_Pkgs(; destdir=normpath(joinpath(@__DIR__, "../pkgs")), git="github")
...
function develop_Pkgs(; destdir=normpath(joinpath(@__DIR__, "../pkgs")), git="github")
    # 拷贝到本地
